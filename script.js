document.addEventListener('DOMContentLoaded', function () {
  ...
  if (contactForm) {
    ...
    function showFormSuccess() {
      ...
      const successFields = contactForm.querySelectorAll('.field-success');
      successFields.forEach(function (f) { f.classList.remove('field-success'); });
    ...
    "translations": {
      "he": {
        "consentModal": {
          ...
          "description": "מוריה ביטוח משתמש בעוגיות כדי לשפר את החוויה שלך, לנתח שימוש באתר ולסייע במאמצי השיווק שלנו.",
...
(function() {
    ...
    contactForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            var payload = {
                websiteId: '22df28da-6964-4c1e-a399-9bb17cdcacbf',
                name: resolvedName,
                email: resolvedEmail,
            ...
            if (result.success) {
                ...
                if (result.thankYouPagePath && result.ticketNumber) {
                    ...
                    if (isPreview && window.ZAPPY_CONFIG) {
                        var wid = window.ZAPPY_CONFIG.websiteId || '22df28da-6964-4c1e-a399-9bb17cdcacbf';
...
(function(){
  try {
    ...
    document.addEventListener('submit', function(e) {
      ...
      var wid = '22df28da-6964-4c1e-a399-9bb17cdcacbf';
